...
<div class="max-w-md mx-auto mt-12 p-6 border border-gray-200 rounded-lg">
  ...
  <form on:submit|preventDefault={onSubmit} class="space-y-4">
    ...
    {/if}
    <button class="inline-flex items-center justify-center rounded bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 disabled:opacity-50" type="submit" disabled={loading}>{loading ? 'Logging in...' : 'Login'}</button>
  </form>
</div>
